...
logging_config = {
    ...
    'handlers': {
        'error_handler': {
            ...
            'level': 'ERROR',
            'filename': '/tmp/logs/news_extractor/errors.log',
        },
        'info_handler': {
            'class': 'logging.FileHandler',
            'formatter': 'debug_formatter',
            'filters': ['file_filter'],
            'filename': '/tmp/logs/news_extractor/app.log',
        },
        'debug_handler': {
            'class': 'logging.FileHandler',
            'formatter': 'debug_formatter',
            'filters': ['debug_filter'],
            'filename': '/tmp/logs/news_extractor/debug.log',
        },
    },
    'root': {
        'level': 'DEBUG',
...
def init_log(name):
    os.makedirs(os.path.dirname('/tmp/logs/news_extractor/'), exist_ok=True)
